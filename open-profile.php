        ...
        <ul class="ms-5">
            ...
            <li class="list-inline-item me-4">
                <a data-bs-toggle="modal" data-bs-target="#followersModal">
                    <h5 class="font-weight-bold mb-0 d-block ms-4"><?php echo count($followers) ?></h5><small
                        class="text-muted">
            ...
            <li class="list-inline-item">
                <a data-bs-toggle="modal" data-bs-target="#followingModal">
                    <h5 class="font-weight-bold mb-0 d-block ms-4"><?php echo count($following) ?></h5><small
                        class="text-muted">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
                <div class="navbar-nav mx-auto">
                    ...
                    <a class="nav-link mx-3 <?php echo $current_route == 'posts' ? 'active' : ''; ?>"
                        aria-current="page" href="open-profile.php?username=<?php echo $accountResult['username'] ?>">
