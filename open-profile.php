    ...
    <div class="container d-flex justify-content-center mt-5 py-5">
      ...
      <ul class="ms-5">
        ...
        <li class="list-inline-item mt-3 me-4">
          <h5 class="font-weight-bold mb-0 d-block ms-2 ">
            <?php echo $dbh->getNumPostFromId($accountResult['id']) ?>
          </h5>
          <small class="text-muted"> <i class="fas fa-image mr-1"></i>Post</small>
        </li>
        <li class="list-inline-item me-4">
          <h5 class="font-weight-bold mb-0 d-block ms-4" data-bs-toggle="modal" data-bs-target="#followersModal" role="button">
        ...
        <li class="list-inline-item">
          <h5 class="font-weight-bold mb-0 d-block ms-4" data-bs-toggle="modal" data-bs-target="#followingModal" role="button">
            <?php echo count($following) ?>
          </h5>
          <small class="text-muted">
    ...
    <div class=" container-fluid justify-content-center ">
      ...
      <div class="active-indicator-container">
        <div class="active-indicator">
          ...
          <div class="half-bar half-bar-right <?php echo $current_route == 'adoptions' ? 'active' : 'inactive'; ?>">
          </div>
        </div>
      </div>
    </div>
          ...
          <?php foreach ($postToShow as $post): ?>
            <div class="col">
              <a href="open-post.php?post_id=<?php echo $post['post_id'] ?>">
                <div class="post-image-container-profile mb-4"> <img src="./img/<?php echo $post['media'][0] ?>"
                    class="img-fluid rounded shadow-sm" alt="" /></div>
              </a>
            </div>
          <?php endforeach; ?>
        </div>
