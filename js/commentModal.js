document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("comment-modal").addEventListener("show.bs.modal", function (event) {
  ...
  document.getElementById("comment-modal").addEventListener("shown.bs.modal", function () {
