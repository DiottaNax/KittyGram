...
if (isset($_GET['post_id'])):
    ...
    if ($_SESSION['user_id'] == $adoption['user_id']):
        ...
        <body>
            ...
            <?php if (count($adoptionRequests) == 0): ?>
                <div class="container-fluid text-center justify-content-center">
                    <p class="d-flex justify-content-center text-center align-items-center">No adoption request yet 😿!</p>
                </div>
            <?php endif; ?>
            ...
            <?php foreach ($adoptionRequests as $adoptionRequest):
                ...
                <div class="container d-flex justify-content-center align-items-center mb-5">
                    <div class="card text-center">
                        <!-- icona del cestino -->
                        <svg data-post-id="<?php echo $adoptionRequest['post_id'] ?>"
                            data-submitter="<?php echo $submitter['username'] ?>" xmlns="http://www.w3.org/2000/svg" width="16"
                            height="16" fill="currentColor" class="remove-request bi bi-trash3 position-absolute top-0 end-0 m-3"
                            viewBox="0 0 16 16">
                            <path
