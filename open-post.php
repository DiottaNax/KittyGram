        ...
        <div class="row">
            ...
            <div class="col-md-5 mt-4">
                  <div class="card">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots position-absolute top-0 end-0 m-3" data-bs-toggle="modal" data-bs-target="#post-settings-modal" viewBox="0 0 16 16">
                ...
                <div class="card mt-3">
                    ...
                    <nav class="navbar navbar-expand mt-3">
                        <div class="container-fluid">
                            <!-- tasto like -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16" id="likeIcon">
                            ...
                            <div class="adoption-icon" data-bs-toggle="modal" data-bs-target="#adoption-modal">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" class="bi bi-house-heart" viewBox="0 0 16 16">
