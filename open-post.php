    ...
    <div class="container mt-5 d-flex justify-content-center align-items-center">
        <div class="row">
            ...
            <div class="col-md-7 mt-4">
                ...
                <img src="./img/cat-example1.jfif" id="postImage" class="card-img-top" style="max-height: 600px; max-width: 600px;" alt="Immagine del post">
            </div>
                ...
                <div class="card mt-3">
                    ...
                    <div class="card mt-2">
                        <div class="d-flex align-items-center">
                            ...
                            <input type="comment" class="form-control transparent-input" placeholder="Add a comment..." id="comment" maxlength="100" name="comment">
                            <button type="button" class="btn btn-primary" id="sendButton" style="display: none;">Send</button>
                        </div>
                    </div>
