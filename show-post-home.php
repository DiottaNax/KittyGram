                        ...
                        <div class="carousel-inner">
                            <?php foreach ($images as $index => $image): ?>
                                <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
                                    <img src="./img/<?php echo $image; ?>" class="d-block w-100 border border-dark" alt="Post Image">
                                </div>
                            <?php endforeach; ?>
                        </div>
            ...
            <div class="row mt-2">
                ...
                <div class="col text-end mb-2">
                    <button class="btn comment" type=" button" data-bs-toggle="modal" data-bs-target="#comment-modal"
                        data-post-id=<?php echo $post["post_id"]; ?> data-post-owner=<?php echo $post["owner"]["username"]; ?>>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class=" bi bi-chat" viewBox="0 0 16 16">
                            <path
